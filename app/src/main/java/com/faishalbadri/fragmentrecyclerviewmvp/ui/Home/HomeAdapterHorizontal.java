...
public class HomeAdapterHorizontal extends RecyclerView.Adapter<HomeAdapterHorizontal.ViewHolder> {
  ...
  Context context;
  List<PojoKategori.KategoriBean> data;

  public HomeAdapterHorizontal(Context context, List<PojoKategori.KategoriBean> data) {
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(context).inflate(R.layout.list_horizontal, parent, false);
